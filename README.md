...
![alt text](src/jobs_ai/static/logo.svg)
...
- LucAI automatic discovery: the agent analyzes your CV, generates search queries, searches jobs, and filters them by your preferences.
...
- LucAI chat panel for asking questions about your CV, matches, and application strategy.
- Platform settings page for InfoJobs, LinkedIn, and Indeed login/configuration.
- Built-in UI language switcher for English, Portuguese (Brazil), and Spanish (Spain).
- Light and dark themes saved locally in the browser.
...
3. Click **LucAI Find Matches** in the UI. LucAI will analyze your CV and search for matching jobs automatically.
...
The **Platforms** page lets you configure InfoJobs, LinkedIn, and Indeed locally. Credentials are stored in your local SQLite database under `data/`, which is ignored by git. Keep manual review enabled for platforms that require MFA, CAPTCHA, Easy Apply confirmation, or external ATS redirects.
